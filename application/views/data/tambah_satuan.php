                    ...
                    <form role="form" method="POST" action="tambah_data">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="kode_satuan">Kode Satuan Barang</label>
                                <input type="text" name="kode_satuan" class="form-control" id="kode_satuan" placeholder="Masukkan Kode Satuan">
                            </div>
                            <div class="form-group">
                                <label for="satuan_barang">Satuan Barang</label>
                                <input type="text" name="satuan_barang" class="form-control" id="satuan_barang" placeholder="Masukkan Satuan Barang">
                            </div>
                        </div>
                        <!-- /.box-body -->
